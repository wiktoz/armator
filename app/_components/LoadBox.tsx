    ...
    return(
        <div className={"rounded-2xl shadow"}>
            <div className={"flex flex-row h-full w-full"}>
                <div className={"flex items-center text-white bg-primary rounded-l-2xl border border-primary px-4"}>
                    <LuBox className={"text-xl"}/>
                </div>
                <div className={"border border-primary flex flex-row h-full w-full rounded-r-2xl"}>
                                ...
                                <Accordion title={"customer"}>
                                    <div className={"flex flex-col gap-2"}>
                                        ...
                                        <div className={"flex flex-row items-center text-sm gap-2"}>
                                            ...
                                            <p className={"border-l border-primary px-2"}>{l.user.email}</p>
                                        </div>
                                        <div className={"flex flex-row items-center text-sm gap-2"}>
                                            <LuMapPin className={"text-xs"}/>
                                            <div className={"border-l border-primary px-2"}>
